...
public abstract class AbstractExcelReader<T> extends
	...
	/**
	 * Public setter for the {@code rowMapper}. Used to map a row read from the
	 ...
	 */
	public void setSkippedRowsCallback(
			final RowCallbackHandler skippedRowsCallback) {
